...
First of all read our [Code of Conduct](https://github.com/hidevopsio/iris/blob/master/CODE_OF_CONDUCT.md).

## PR

1. Open a new [issue](https://github.com/hidevopsio/iris/issues/new)
...
2. Fork the [repository](https://github.com/hidevopsio/iris).
3. Make your changes.
4. Compare & Push the PR from [here](https://github.com/hidevopsio/iris/compare).
...
Instructions can be found at: https://github.com/hidevopsio/iris/issues/796
