...
**如何升级**: 打开命令行执行以下命令: `go get -u github.com/hidevopsio/iris` 或者等待自动更新。

# Tu, 30 October 2018 | v11.0.2

This history entry is not translated yet to the Chinese language yet, please refer to the english version of the [HISTORY entry](https://github.com/hidevopsio/iris/blob/master/HISTORY.md#tu-30-october-2018--v1102) instead.

# Su, 28 October 2018 | v11.0.1

This history entry is not translated yet to the Chinese language yet, please refer to the english version of the [HISTORY entry](https://github.com/hidevopsio/iris/blob/master/HISTORY.md#su-28-october-2018--v1101) instead.

# Su, 21 October 2018 | v11.0.0

This history entry is not translated yet to the Chinese language yet, please refer to the english version of the [HISTORY entry](https://github.com/hidevopsio/iris/blob/master/HISTORY.md#su-21-october-2018--v1100) instead.

# Sat, 11 August 2018 | v10.7.0

This history entry is not translated yet to the Chinese language yet, please refer to the english version of the [HISTORY entry](https://github.com/hidevopsio/iris/blob/master/HISTORY.md#sat-11-august-2018--v1070) instead.

# Tu, 05 June 2018 | v10.6.6

This history entry is not translated yet to the Chinese language yet, please refer to the english version of the [HISTORY entry](https://github.com/hidevopsio/iris/blob/master/HISTORY.md#tu-05-june-2018--v1066) instead.

# Mo, 21 May 2018 | v10.6.5

This history entry is not translated yet to the Chinese language yet, please refer to the english version of the [HISTORY entry](https://github.com/hidevopsio/iris/blob/master/HISTORY.md#mo-21-may-2018--v1065) instead.
...
This history entry is not translated yet to the Chinese language yet, please refer to the english version of the [HISTORY entry](https://github.com/hidevopsio/iris/blob/master/HISTORY.md#we-02-may-2018--v1063) instead.

# Tu, 01 May 2018 | v10.6.2

This history entry is not translated yet to the Chinese language yet, please refer to the english version of the [HISTORY entry](https://github.com/hidevopsio/iris/blob/master/HISTORY.md#tu-01-may-2018--v1062) instead.
...
- 修正 重定向问题 由 @wozz 提交: https://github.com/hidevopsio/iris/pull/972.
- 修正 无法销毁子域名 session 问题 由 @Chengyumeng 提交: https://github.com/hidevopsio/iris/pull/964.
- 添加 `OnDestroy(sid string)` 当 session 销毁时注册监听器 相关细节: https://github.com/hidevopsio/iris/commit/d17d7fecbe4937476d00af7fda1c138c1ac6f34d.
- sessions 现在与注册数据库完全同步。 这涉及到很多内部改动，但 **这不影响你当前项目代码**. 我们只保留了 `badger` 和 `redis` 作为底部支持。 相关细节: https://github.com/hidevopsio/iris/commit/f2c3a5f0cef62099fd4d77c5ccb14f654ddbfb5c 

# 2018 3月 24日 | v10.5.0 版本更新

### 新增

新增 缓存中间件客户端，更快的静态文件服务器. 详情 [点击](https://github.com/hidevopsio/iris/pull/935).
...
由 @jefurry 提出 https://github.com/hidevopsio/iris/issues/937.
...
- 修正 路径 `{}` 中的路径清理 (我们已经在 [解释器](macro/interpreter) 级别转义了这些字符， 但是一些符号仍然被更高级别的API构建器删除) , 例如 `\\` 字符串的宏函数正则表达式内容 [927](https://github.com/hidevopsio/iris/issues/927) by [commit e85b113476eeefffbc7823297cc63cd152ebddfd](https://github.com/hidevopsio/iris/commit/e85b113476eeefffbc7823297cc63cd152ebddfd)
...
- 修复 POST 请求尾部斜杠重定向问题: https://github.com/hidevopsio/iris/issues/921 https://github.com/hidevopsio/iris/commit/dc589d9135295b4d080a9a91e942aacbfe5d56c5

- 新增示例 通过 `iris#UnmarshalerFunc` 自定义解码， 新增 `context#ReadXML` 使用示例, [相关示例](https://github.com/hidevopsio/iris/tree/master/_examples#how-to-read-from-contextrequest-httprequest)via https://github.com/hidevopsio/iris/commit/78cd8e5f677fe3ff2c863c5bea7d1c161bf4c31e.

- 新增自定义路由宏功能示例, 相关讨论 https://github.com/hidevopsio/iris/issues/918, [示例代码](https://github.com/hidevopsio/iris/blob/master/_examples/routing/dynamic-path/main.go#L144-L158), https://github.com/hidevopsio/iris/commit/a7690c71927cbf3aa876592fab94f04cada91b72

- 为 `Pongo` 新增 `AsValue()` 和 `AsSaveValue()` @neenar https://github.com/hidevopsio/iris/pull/913

- 删除 `context#UnmarshalBody` 上不必要的反射 https://github.com/hidevopsio/iris/commit/4b9e41458b62035ea4933789c0a132c3ef2a90cc
...
正如 @likakuli 指出的那样 https://github.com/hidevopsio/iris/issues/901, 以前 `Done` 注册的处理器，在全局范围内会替代子处理器，因为在引入 `UseGlobal` 这概念之前，缺少稳定性. 现在是时候了, 新的 `Done` 应该在相关的路由之前调用， **新增** `DoneGlobal` 之前的`Done` 使用相同; 顺序无关紧要，他只是结束处理附加到当前的注册程序, 全局性的 (所有子域名，分组).
...
- 多级域名跳转, 相关示例 [here](https://github.com/hidevopsio/iris/blob/master/_examples/subdomains/redirect/main.go)
- 缓存中间件携带 `304` 状态码, 缓存期间的请求，服务器只响应状态, 相关示例 [here](https://github.com/hidevopsio/iris/blob/master/_examples/cache/client-side/main.go)
...
- [改进：不在gzip响应的WriteString和Writef上强制设置内容类型（如果已经存在的话）](https://github.com/hidevopsio/iris/commit/af79aad11932f1a4fcbf7ebe28274b96675d0000)
- [新增：websocket/Connection#IsJoined](https://github.com/hidevopsio/iris/commit/cb9e30948c8f1dd099f5168218d110765989992e)
- [修复：#897](https://github.com/hidevopsio/iris/commit/21cb572b638e82711910745cfae3c52d836f01f9)
- [新增：context#StatusCodeNotSuccessful 变量用来定制 rfc2616-sec10](https://github.com/hidevopsio/iris/commit/c56b7a3f04d953a264dfff15dadd2b4407d62a6f)
- [修复：示例 routing/dynamic-path/main.go#L101](https://github.com/hidevopsio/iris/commit/0fbf1d45f7893cb1393759b7362444f3d381d182)
- [新增：缓存中间件 `iris.Cache304`](https://github.com/hidevopsio/iris/commit/1722355870174cecbc12f7beff8514b058b3b912)
- [修复：示例  csrf](https://github.com/hidevopsio/iris/commit/a39e3d7d6cf528e51e6c7e32a884a8d9f2fadc0b)
- [取消：Configuration.RemoteAddrHeaders 默认值](https://github.com/hidevopsio/iris/commit/47108dc5a147a8b23de61bef86fe9327f0781396)
- [新增：vscode 扩展链接和徽章](https://github.com/hidevopsio/iris/commit/6f594c0a7c641cc98bd683163fffbf5fa5fc8de6)
- [新增：`app.View` 示例 用于解析和编写HTTP之外的模板（类似于上下文＃视图)](_examples/view/write-to)
- [新增：支持多级域名跳转](https://github.com/hidevopsio/iris/commit/12d7df113e611a75088c2a72774dab749d2c7685).
...
- 修复缓存在同一控制器多个方法中，返回相同内容问题 https://github.com/hidevopsio/iris/pull/852, 问题报告：https://github.com/hidevopsio/iris/issues/850
- 问题修正 https://github.com/hidevopsio/iris/pull/862
- 当 `view#Engine##Reload` 为 true，`ExecuteWriter -> Load` 不能同时使用问题，相关问题 ：https://github.com/hidevopsio/iris/issues/872
...
1. 中文版 README_ZH.md and HISTORY_ZH.md 由 @Zeno-Code 翻译 https://github.com/hidevopsio/iris/pull/858
2. 俄语版 README_RU.md 由 @merrydii 翻译 https://github.com/hidevopsio/iris/pull/857
3. 希腊版 README_GR.md and HISTORY_GR.md https://github.com/hidevopsio/iris/commit/8c4e17c2a5433c36c148a51a945c4dc35fbe502a#diff-74b06c740d860f847e7b577ad58ddde0 and https://github.com/hidevopsio/iris/commit/bb5a81c540b34eaf5c6c8e993f644a0e66a78fb8
