...
[View or download sample code](https://github.com/hidevopsio/iris/tree/master/_examples/websocket).
...
* import the `"github.com/hidevopsio/iris/websocket"`
...
```go
import "github.com/hidevopsio/iris/websocket"
```
